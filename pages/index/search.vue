	...
	<view>
		<view class="head">
			...
			<view class="search">
				...
				<input class="search-title" style="color: black;" v-model="serviceName">
			</view>
			<view v-if="!hasSearch" class="search-btn" @tap="goSearch()">搜索</view>
			<view v-if="hasSearch" class="search-btn" @tap="cancelSearch()">取消</view>
		</view>
			...
			<view class="item" @tap="toShop(shop.id)" v-for="shop in shops" :key="shop.id">
				...
				<view class="services">
					<view class="services-item">
						<view class="item-name">汽车保养</view>
						<view class="item-price">￥999.00    > </view>
					</view>
					<view class="services-item">
						<view class="item-name">汽车保养</view>
						<view class="item-price">￥999.00    > </view>
...
<style lang="less" scoped>
	...
	.head {
		display: flex; padding: 19upx; justify-content: space-between;
		.area {
		...
		.search {
			...
			width: 480upx; height: 64upx; background: rgba(237,237,237,1); border-radius: 10upx;
			.search-img {
		...
		.search-btn {
			color: rgba(66,66,66,1); font-size: 28upx; height: 64upx; line-height: 64upx;
		}
	}
	.swiper {
		.swiper-box {
	...
	.list {
		.item {
			...
			.item-cover {
				...
				top: 30upx; left: 30upx; background: 50% 50% #1B82D2 no-repeat;
			...
			.services {
				...
				.services-item {
					margin-bottom: 30upx;
					border-top-left-radius: 30upx; border-bottom-left-radius: 30upx;;
					width: 510upx; height: 60upx; line-height: 60upx;
					float: right; border-top: 1px solid #3F91D8; margin-right: -30upx;
					border-bottom: 1px solid #3F91D8; border-left: 1px solid #3F91D8;
					.item-name {
						display: inline-block; margin-left: 30upx;
						font-size: 30upx; font-weight: 500; color: rgba(51,51,51,1);
					}
					.item-price {
						float: right; margin-right: 30upx;
						font-size: 30upx; font-weight: 500; color: rgba(250,43,43,1);
					}
				}
			}
			.enter-shop {
				font-size: 26upx; font-weight: 500; color: rgba(153,153,153,1); line-height: 50upx;
			}
		}
	}
</style>
