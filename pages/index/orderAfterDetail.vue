<template>
	<view>
		<view class="status" v-if="order.status === 1">待商家处理</view>
		<view class="status" v-if="order.status === 2">待买家处理</view>
		<view class="status" v-if="order.status === 3">退款成功</view>
		<view class="status" v-if="order.status === 4">退款关闭</view>
