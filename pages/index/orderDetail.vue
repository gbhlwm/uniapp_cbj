<template>
	<view>
		<view class="status" v-if="order.status === 1">待支付</view>
		<view class="status" v-if="order.status === 2">待使用</view>
		<view class="status" v-if="order.status === 3">待评价</view>
		<view class="status" v-if="order.status === 4">已完成</view>
		<view class="status" v-if="order.status === 5">已取消</view>
